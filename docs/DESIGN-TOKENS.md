...
Home, the dashboard (T41): "You're covered." / "Claims are open for your occupation." / "Your claim is being decided." / "Your claim has been paid." / "Your cover needs a payment." / "What has happened" / "Nothing has happened on this cover yet." / "Your cover key" / "Show cover key" / "Keep this somewhere safe. It is how you get back in anywhere." / "Sign out of this cover"
Getting back in (T41): "Get back into your cover" / "World ID is how you get back in on your own phone. Your cover key is how you get back in anywhere." / "Sign in with World ID" / "Cover key" / "The twenty characters you were given when you bought your cover." / "Open my cover" / "That key doesn't open a cover. Check it and try again." / "No cover yet." / "That World ID hasn't bought cover. Getting one takes about two minutes." / "Get a quote"
