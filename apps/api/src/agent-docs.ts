...
export function renderLlmsTxt(options: AgentDocsOptions = {}): string {
  ...
  return [
    ...
    `- [The attribution series](${origin}/v1/attribution): free. Announced United States job`,
    '  cuts where the employer itself named artificial intelligence, month by month since May',
    '  2023, with its limits and how weakly it correlates with the index. Context only. It does',
    '  not affect settlement and nothing in it can open or close a claim.',
    '',
